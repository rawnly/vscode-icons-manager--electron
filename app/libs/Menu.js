	...
	submenu: [{
		...
		submenu: [{
			...
			click: function click() {
				return shell.openExternal('https://github.com/dhanishgajjar/vscode-icons');
			}
		}, {
			label: 'This project',
			click: function click() {
				return shell.openExternal('https://github.com/rawnly/vscode-icons-desktop');
			}
		}]
	}, {
		label: 'Report an issue...',
		click: function click() {
			return shell.openExternal('https://github.com/rawnly/vscode-icons-desktop/issues');
		}
	}]
}];
